...
#SBATCH -J QU4bwLOS
#SBATCH -o ./logs/QU4bwLOS.out
#SBATCH -e ./logs/QU4bwLOS.err
#SBATCH -p cosma7
#SBATCH -A dp004
#SBATCH --exclusive
...
restarts_b=0  # optimize position angle with shear angle
restarts_c=0  # optimize ellipticity with shear 
...
# nimgs=4 & a -> 359
# nimgs=4 & b -> 471
./quasar_run_c7.bash $los $nimgs 471 64 &&
